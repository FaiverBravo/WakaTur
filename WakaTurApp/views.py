...
def registro(request):
    ...
    # context = {'form': form}
    return render(request, "WakaTurApp/authentication/registro.html" )
...
# login de ususario
    ...
    if request.method =='POST':
        ...
        return render(request, "WakaTurApp/authentication/login.html")

def home(request):

    return render(request, "WakaTurApp/home.html")
