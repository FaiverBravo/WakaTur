...
var gastronomiaMarkers = [
    new CustomMarker(1.886418, -76.277312, gastronomiaIcon, '<div align="center" style="height: auto; width: 200px;"><h4>Doña Nury</h4><img width="100%" height="100%" src="' + staticUrls.doñaNury1Image + '"><p>informate <a href="http://127.0.0.1:8000/RupestreApp/" target="_blank">aca</a></p></div>'),
    new CustomMarker(1.885837, -76.275916, gastronomiaIcon, '<div align="center" style="height: auto; width: 200px;"><h4>Andrés a la Parrilla</h4><img width="100%" height="100%" src="' + staticUrls.r2Image + '"><p>informate <a href="http://127.0.0.1:8000/RupestreApp/" target="_blank">aca</a></p></div>'),
    new CustomMarker(1.88701, -76.279091, gastronomiaIcon, '<div align="center" style="height: auto; width: 200px;"><h4>Donde Richard</h4><img width="100%" height="100%" src="' + staticUrls.dondeRichard1Image + '"><p>informate <a href="http://127.0.0.1:8000/RupestreApp/" target="_blank">aca</a></p></div>'),
