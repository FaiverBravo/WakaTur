"""
Django settings for WakaTur project.
...
INSTALLED_APPS = [
    ...
    'contacto',
    'tienda',
    'colorfield',# Para usar usar diseños en la interface de django
    'django_distill',# Para servir tu aplicación Django en GitHub Pages
]
...
EMAIL_HOST_PASSWORD="bwhpwq24a6"
